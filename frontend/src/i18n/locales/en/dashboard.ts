export default {
  ...
  usage: {
    ...
    appliedRateMultiplier: 'Applied billing rate ×{value}',
    currentBillingMultiplier: 'Applied billing rate',
    longContextPricingApplied: 'Long-context tier pricing applied',
    ...
    outputTps: 'Output rate',
    outputTpsHint: 'Output tokens divided by generation time (total duration minus time to first token); falls back to total duration when unavailable',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
