export default {
  ...
  backup: {
    ...
    imageStorage: {
      ...
      description: 'Configure S3-compatible storage for asynchronously generated images.',
      enabled: 'Enable image storage',
      reuseBackupS3: 'Reuse database backup S3 configuration',
      bucket: 'Bucket',
      bucketInherited: 'Inherited from backup S3 configuration',
      prefix: 'Key prefix',
      publicBaseUrl: 'Public base URL',
      publicBaseUrlPlaceholder: 'https://cdn.example.com',
      presignExpiryHours: 'Presigned URL expiry (hours)',
  ...
  users: {
    ...
    bulkLimits: {
      ...
      enableConcurrency: 'Enable concurrency update',
      enableRPMLimit: 'Enable RPM limit update',
      unlimited: '0 means unlimited',
      nonNegativeInteger: 'Values must be non-negative integers.',
      selectionLimit: 'Select no more than {max} users.',
      applying: 'Applying...',
      apply: 'Apply changes',
      concurrencyValue: 'Concurrency: {value}',
      rpmUnlimitedValue: 'RPM: unlimited',
      rpmValue: 'RPM: {value}',
      confirm: 'Apply {fields} to {count} selected users?',
  ...
  groups: {
    ...
    form: {
      ...
      maxReasoningEffortHint: 'Requests using a higher reasoning effort will be capped at this value.',
      ...
      reasoningEffortFromPlaceholder: 'Select source effort',
      reasoningEffortTo: 'To',
      reasoningEffortToPlaceholder: 'Select target effort',
      removeReasoningEffortMapping: 'Remove mapping',
      fromRequired: 'Select a source effort.',
      toRequired: 'Select a target effort.',
      duplicateFrom: 'Each source effort can only be mapped once.',
      unsupportedFrom: 'This source effort is not supported on the selected platform.',
      unsupportedTo: 'This target effort is not supported on the selected platform.'
    },
    exclusiveObj: {
      yes: 'Yes',
      no: 'No'
    ...
    duplicate: 'Duplicate',
    duplicateSuccess: 'Group duplicated as "{name}"',
