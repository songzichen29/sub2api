  ...
  settings: {
    ...
    features: {
      channelMonitor: {
        ...
        mode: 'Monitor mode',
        modeHint: 'Default is V2 (passive aggregation). Switch to V1 only for legacy active-probe behavior; only one implementation can be active at a time.',
        ...
        modeV1Hint: 'Compatibility mode: runs scheduled upstream health checks for configured channel monitors (probe traffic).',
    ...
    defaults: {
      ...
      defaultSubscriptionsInvalid: 'Invalid default subscription: days mode requires a positive validity, range mode requires valid start/end time and end time must be in the future.',
