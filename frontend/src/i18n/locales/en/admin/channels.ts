export default {
  ...
  channelMonitor: {
    ...
    duplicate: 'Duplicate',
    duplicateKeyUnavailable: 'Cannot duplicate this monitor because its API key is unavailable. Please edit it with a fresh key.',
    duplicateSuccess: 'Monitor duplicated as "{name}"',
