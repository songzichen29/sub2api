export default {
  ops: {
    ...
    errorIngestion: {
      ...
      description: 'Separates queued, processed, and persisted errors, and shows authentication or admission rejections that do not enter the regular error table.',
      refresh: 'Refresh ingestion status',
      errorPipeline: 'Error log ingestion',
      rejectPipeline: 'Ingress rejection ingestion',
      state: {
        healthy: 'Healthy',
      ...
      pending: 'Pending',
      flushed: 'Persisted requests',
      overflowed: 'Overflowed',
      recentRejects: 'Recent ingress rejections',
      total: '{count} items',
      emptyRejects: 'No ingress rejections in the current time window.',
      reason: 'Reason',
      route: 'Route / Protocol',
      identity: 'User / API Key',
      count: 'Requests',
      lastSeen: 'Last seen',
      errorHealth: 'error ingestion health',
      rejectHealth: 'ingress rejection health',
      rejectList: 'ingress rejection list',
      loadFailed: 'Failed to load: {targets}',
      reasons: {
        query_api_key_deprecated: 'API Key in query string is not allowed',
        api_key_required: 'API Key required',
        invalid_api_key: 'Invalid API Key',
        invalid_auth_rate_limited: 'Invalid authentication rate limited',
        api_key_auth_overloaded: 'API Key authentication overloaded',
        api_key_disabled: 'API Key disabled',
        ip_restricted: 'IP is not allowed',
        user_inactive: 'User inactive',
        group_deleted: 'Group deleted',
        group_disabled: 'Group disabled',
        group_not_allowed: 'Group not allowed',
        group_unassigned: 'API Key has no group',
        other: 'Other ingress rejection'
      }
    },
    ...
    tooltips: {
      ...
      errorDistribution: 'Distribution of all errors by status code, including business limits. Open details to inspect the complete records.',
