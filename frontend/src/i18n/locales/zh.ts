export default {
  ...
  admin: {
    ...
    affiliates: {
      ...
      rebatesDescription: '查看每一笔产生返利的充值/订阅订单',
    ...
    groups: {
      ...
      subscription: {
        ...
        allowDailyOverdraftHint: '开启后用户可在自己的订阅中自行开关透支；默认关闭。必须配置日限额，透支池按订阅有效天数 × 日限额计算。',
        overdraftShort: '支持透支',
        noLimit: '无限制'
      },
      imagePricing: {
    ...
    channels: {
      ...
      form: {
        ...
        selectedCount: '已选 {count} 个',
        importModelsFromAccounts: '导入分组账号模型到映射和定价',
        selectGroupsBeforeImport: '请先选择分组再导入模型',
    ...
    riskControl: {
      ...
      moderationProtocol: '审核协议',
      protocolOpenAI: 'OpenAI Moderation',
      protocolOpenAIDesc: '调用 OpenAI 官方 Moderation API，使用专用分类模型进行内容审核。',
      protocolAnthropic: 'Anthropic LLM',
      protocolAnthropicDesc: '调用兼容 Anthropic Messages 协议的 LLM 服务（如千问），使用系统提示词定义审核行为。',
      systemPrompt: '系统提示词',
      systemPromptPlaceholder: '请输入系统提示词，用于定义 LLM 的审核行为和输出格式...',
      systemPromptHint: '提示词用于指导 LLM 如何评估内容，并返回 JSON 格式的审核结果。',
      ...
      timeoutMsHint: 'LLM 审核需要更长时间，建议设置为 10000-30000ms',
      retryCount: '失败重试次数',
      sampleRate: '采样率',
    ...
    subscriptions: {
      ...
      monthly: '每月',
      totalQuota: '总额度',
      totalQuotaRemaining: '剩余额度：${amount}',
      overdraftTotal: '透支总额',
      ...
      form: {
        ...
        expiresAt: '结束时间',
        adjustDays: '调整天数',
        adjustDaysRange: '结束时间偏移（天）'
      },
      assignModeDays: '按天数',
      assignModeRange: '按时间段',
      assignModeHint: '可按有效天数分配，或直接指定开始/结束时间',
      selectUser: '选择用户',
      selectGroup: '选择订阅分组',
      groupHint: '仅显示订阅计费类型的分组',
      validityHint: '订阅的有效天数',
      timeRangeHint: '使用本地时区录入，提交后会自动转换为标准时间',
      timeRangeRequired: '请填写完整的开始时间和结束时间',
      timeRangeInvalid: '结束时间必须晚于开始时间',
      timeRangeMustBeFuture: '结束时间必须晚于当前时间',
      ...
      adjustRangeDaysHint: '正数延期、负数提前；起始时间保持不变，下方“结束时间”为新结束时间预览',
      adjustModeHint: '按天数时仅修改到期时间；按时间段时保持当前开始时间并调整结束时间',
      rangeAdjustHint: '时间段模式下，开始时间保持为原配置，结束时间按调整天数自动计算',
      assign: '分配',
      assigning: '分配中...',
      adjust: '调整',
      adjusting: '调整中...',
      ...
      resetQuotaConfirm: "确定要重置 '{user}' 的用量配额吗？用量将归零并从今天开始重新计算。",
      resetQuotaSelectorHint: '选择要重置的窗口；上限窗口和未配置档不可重置。',
    ...
    accounts: {
      ...
      dataImportApplyTitle: '应用到所有账号（可选）',
      dataImportApplyHint: '勾选的字段将覆盖文件里所有账号的同名值，未勾选保留文件原值',
      dataImportTemplateTitle: '导入模板',
      dataImportTemplateHint: '保存常用导入勾选项，下次直接选择模板套用。',
      dataImportTemplateSelect: '选择模板',
      dataImportTemplateSave: '保存为模板',
      dataImportTemplateSaved: '导入模板已保存',
      dataImportTemplateDeleted: '导入模板已删除',
      dataImportTemplateNamePrompt: '请输入模板名称',
      dataImportTemplateNamePlaceholder: '请输入模板名称',
      dataImportApplyTags: '标签',
      dataImportApplyTagsPlaceholder: '输入标签后按 Enter 确认',
      dataImportApplyTagsHint: '勾选后所有导入账号的标签将被替换为此处输入的内容；留空表示显式清空',
      dataImportApplyGroups: '分组',
      dataImportApplyGroupsHint: '勾选后所有导入账号将绑定到此处选中的分组（覆盖文件原绑定）',
      dataImportApplyProxy: '代理',
      dataImportApplyProxyHint: '勾选后所有导入账号将使用此处选中的代理；未选具体代理时本字段不会生效',
      dataImportApplyConcurrency: '并发数',
      dataImportApplyPriority: '优先级',
      dataImportApplyModelRestriction: '模型限制',
      ...
      openaiQuotaReset: {
        count: '次数',
        reset: '重置',
        confirmTitle: '确认重置 OpenAI 额度窗口',
        confirmMessage: '确定消耗 1 次重置次数来重置当前可用窗口吗？当前剩余 {count} 次。',
      ...
      antigravityProjectIdPlaceholder: '输入 Antigravity Project ID',
      antigravityProjectIdHint: '仅 Antigravity OAuth 账号使用；留空则保持原有配置。',
      ...
      openai: {
        ...
        codexCLIOnlyAppServer: '允许 Codex app-server',
        codexCLIOnlyAppServerDesc:
          '仅在“仅允许 Codex 官方客户端”开启时生效。开启后额外放行 Codex app-server 客户端。',
        ...
        responsesModeTextDisabledHint: '当前已禁用文本生成端点能力，Responses API 支持模式不生效。',
        endpointCapabilities: '端点能力',
        endpointCapabilitiesDesc:
          '选择该账号允许参与调度的 OpenAI 端点能力。至少保留一个能力；关闭文本生成后，该账号不会参与 Chat Completions/Responses 文本请求。',
        capabilityResponses: '文本生成：Responses',
        capabilityChatCompletions: '文本生成：Chat Completions',
        capabilityResponsesAuto: '文本生成：Responses（自动探测）',
        capabilityChatCompletionsAuto: '文本生成：Chat Completions（自动探测）',
        capabilityTextAuto: '文本生成：自动',
      ...
      poolModeRetryStatusCodes: '池模式重试状态码',
      poolModeRetryStatusCodesHint: '仅在池模式下生效。用逗号分隔，留空使用默认：{default}。',
      ...
      autoPause5hDisabled: '禁用 5 小时自动暂停',
      autoPause7dDisabled: '禁用 7 天自动暂停',
      autoPauseDisabledHint: '开启后，该账号即使达到阈值也不会被自动暂停',
      autoPause5hThreshold: '5 小时阈值 (%)',
      autoPause7dThreshold: '7 天阈值 (%)',
      autoPauseThresholdHint: '填写 0-100 的百分比；0 表示禁用该窗口的自动暂停',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          rechargeEnabled: '启用充值返利',
          rechargeEnabledHint: '开启后，被邀请用户余额充值时可按比例返利给邀请人。',
      ...
      customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置专属邀请码、专属充值返利比例或专属订阅返利比例。仅展示已设置过专属配置的用户。',
            addButton: '添加专属用户',
          ...
          modal: {
            ...
            rateLabel: '专属返利比例（兼容字段，可选）',
            ratePlaceholder: '例如 30',
            rateHint: '0-100%；仅作为未设置专属充值/订阅比例时的兼容回退。留空（编辑模式下）表示清除。',
            rechargeRateLabel: '专属充值返利比例（可选）',
            rechargeRatePlaceholder: '例如 20',
            rechargeRateHint: '0-100%；留空（编辑模式下）表示清除专属充值返利并沿用系统充值返利。',
            subscriptionRateLabel: '专属订阅返利比例（可选）',
            subscriptionRatePlaceholder: '例如 5',
            subscriptionRateHint: '0-100%；留空（编辑模式下）表示清除专属订阅返利并沿用系统订阅返利。',
            errorBadRate: '请输入 0-100 之间的比例',
            errorEmpty: '至少填写一项：专属邀请码、专属返利比例、专属充值返利比例或专属订阅返利比例',
          },
          batchModal: {
      ...
      defaults: {
        ...
        defaultSubscriptionsInvalid: '默认订阅配置无效：按天数模式需填写有效天数，按时间段模式需填写有效的开始/结束时间且结束时间晚于当前时间。',
        subscriptionGroup: '订阅分组',
        subscriptionAssignMode: '分配方式',
        subscriptionAssignModeDays: '按天数',
        subscriptionAssignModeRange: '按时间段',
        subscriptionValidityDays: '有效期（天）',
        subscriptionStartsAt: '开始时间',
        subscriptionExpiresAt: '结束时间'
      },
      claudeCode: {
      ...
      site: {
        ...
        openaiFreeImageBridgeUrl: 'OpenAI Free 生图桥接地址',
        openaiFreeImageBridgeUrlHint: '仅用于将 OpenAI OAuth Free 图片请求桥接到 chatgpt2api，不影响其他链路。',
        openaiFreeImageBridgeUrlPlaceholder: 'http://127.0.0.1:8000',
        openaiFreeImageBridgeAuthKey: 'OpenAI Free 生图桥接密钥',
        openaiFreeImageBridgeAuthKeyHintConfigured: '当前已配置桥接鉴权密钥；留空表示本次不修改。',
        openaiFreeImageBridgeAuthKeyHintMissing: '当前未配置桥接鉴权密钥。',
        openaiFreeImageBridgeAuthKeyPlaceholder: 'bridge-chatgpt2api-key-001',
      ...
      payment: {
        ...
        paidUserRateEnabled: '余额充值后自动设置付费用户专属倍率',
        paidUserRateTitle: '付费用户专属倍率',
        paidUserRateHint: '余额充值成功后，自动为用户写入下列分组倍率。',
        paidUserRateGroup: '目标分组',
        paidUserRateMultiplier: '专属倍率',
        paidUserRateAssignedUsers: '已分配用户',
        addPaidUserRateRule: '添加分组倍率',
        noPaidUserRateRules: '暂无分组倍率规则，添加后自动生效。',
        paidUserRateBackfillSuccess: '历史余额充值用户 {total} 人，已按 {rules} 条规则分配给 {assigned} 人。',
        paidUserRateBackfillFailed: '历史余额充值用户 {total} 人，已分配 {assigned} 人，回填失败：{error}',
        paidUserRateBackfillSkipped: '尚未执行历史用户回填。',
        selectGroup: '请选择分组',
        discountRules: '满减规则',
        discountRulesHint: '按订单金额自动匹配最高门槛规则；每日限额重置订单不适用。',
        addDiscountRule: '添加满减规则',
        noDiscountRules: '暂无满减规则。',
        quickAmounts: '快捷充值金额',
        quickAmountsPlaceholder: '例如 1, 10, 30, 50, 100, 200',
        quickAmountsHint: '逗号或空格分隔；留空使用系统默认档位，满减门槛仍会自动加入前台快捷金额。',
        discountThreshold: '门槛金额',
        discountType: '类型',
        ...
        alipayGuideSummary: '桌面端和 H5 端都必须生成当面付扫码单；手机端可长按二维码后在支付宝识别付款。',
        alipayGuideFaceToFaceTitle: '当面付 / 扫码支付',
        alipayGuideFaceToFaceOpen: '需开通当面付或扫码支付能力。',
        alipayGuideFaceToFaceCall: '桌面端和 H5 端下单时统一调用 alipay.trade.precreate，前台直接渲染二维码。',
        alipayGuideFaceToFaceFallback: '接口不可用或返回失败时直接报错，不会降级到手机网站支付或电脑网站支付。',
        alipayGuidePagePayTitle: '电脑网站支付',
        alipayGuidePagePayOpen: '需开通电脑网站支付。',
        alipayGuidePagePayCall: '当前系统不再把桌面扫码单降级为 alipay.trade.page.pay。',
        alipayGuidePagePayFallback: '如果需要桌面收银台链接，应单独接入电脑网站支付，而不是伪装成当面付二维码。',
        alipayGuideWapTitle: 'H5 端二维码',
        alipayGuideWapOpen: '无需手机网站支付；需确保当面付可用。',
        alipayGuideWapCall: 'H5 端展示同一份当面付二维码，用户可长按保存后在支付宝中识别。',
        alipayGuideWapFallback: '不会跳转 WAP 收银台；当面付失败时直接提示错误。',
  ...
  userSubscriptions: {
    ...
    monthly: '每月',
    daysRemaining: '剩余 {days} 天',
    exactRemaining: '剩余 {time}',
    expiresOn: '{date} 到期',
    resetIn: '{time} 后重置',
    windowNotActive: '等待首次使用',
    usageOf: '已用 {used} / {limit}',
    dailyOverdraft: '日额度透支',
    dailyOverdraftHint: '开启后每日额度用完仍可继续使用，消耗订阅有效天数内的未来日额度；默认关闭。',
    overdraftTotal: '总额度',
    totalQuota: '总额度',
    totalQuotaRemaining: '剩余额度 ${amount}',
    todayOverdraft: '今日透支额度',
    overdraftRemaining: '透支剩余额度',
    borrowedFutureDays: '已借用未来天数',
    borrowedFutureQuota: '已借用未来额度',
    overdraftDaysValue: '{days} 天',
    overdraftDays: '已借用未来天数：{days} 天',
  ...
  payment: {
    ...
    fee: '手续费',
    actualPay: '实付金额',
    thresholdDiscount: '满减优惠',
    couponDiscount: '优惠券优惠',
    couponApplied: '优惠券已应用',
    couponNoDiscount: '优惠券未产生抵扣',
    couponInvalid: '优惠券不可用',
    thresholdRateHint: '满 {threshold} 享 {rate} 折',
    thresholdReduceHint: '满 {threshold} 减 {amount}',
    thresholdDiscountBadge: '{rate}折',
    thresholdReduceBadge: '减 {amount}',
    quickAmountPay: '实付 {amount}',
    quickAmountSave: '节省 {amount}',
    createOrder: '确认支付',
    methods: {
      easypay: '易支付',
      alipay: '支付宝',
    ...
    desktopAlipayTitle: '请回到电脑端完成支付宝支付',
    desktopAlipayDescription: '当前移动端发起支付宝支付体验不稳定，请回到电脑端继续操作。',
    desktopAlipayCurrentPage: '回到电脑端后打开这个地址',
    desktopAlipayCopyPageLink: '复制页面地址',
    desktopAlipayHint: '复制后可在电脑浏览器打开；如果地址里带了金额或套餐信息，页面会自动帮你恢复。',
    ...
    errors: {
      ...
      PLAN_PURCHASE_LIMIT_REACHED: '已达到该套餐的限购次数',
      ...
      INVALID_DISCOUNT_RULES: '满减规则配置不合法，请检查门槛、类型和数值',
      COUPON_INVALID: '优惠券无效或不存在',
      COUPON_EXPIRED: '优惠券已过期',
      COUPON_DISABLED: '优惠券已停用',
      COUPON_NOT_STARTED: '优惠券尚未生效',
      COUPON_EXHAUSTED: '优惠券已用完',
      COUPON_USER_LIMIT_REACHED: '你已达到该优惠券的使用次数限制',
      COUPON_SCOPE_MISMATCH: '该优惠券不适用于当前订单类型',
      COUPON_NOT_APPLICABLE: '该订单不可使用优惠券',
      COUPON_MIN_AMOUNT_NOT_MET: '未满足优惠券最低消费门槛',
      INVALID_COUPON_TYPE: '优惠券类型不合法',
      INVALID_COUPON_VALUE: '优惠券面值不合法',
      INVALID_COUPON_SCOPE: '优惠券适用范围不合法',
      INVALID_COUPON_LIMITS: '优惠券使用次数限制不合法',
      REFUND_FAILED: '退款失败',
    },
    stripePay: '立即支付',
    ...
    subscribeNow: '立即开通',
    renewNow: '续费',
    renewalNoticeTitle: '续费提示',
    renewalResetNoticeTitle: '重置提示',
    renewalNotice: '剩余 {time}，可继续使用。',
    renewalNoticeUnlimited: '剩余 {time}，可继续使用。',
    renewalRemainingItem: '{label}剩余 {amount}',
    renewalRuleExtend: '延长时间',
    renewalRuleDailyReset: '1天卡会刷新今日额度',
    renewalRuleWeeklyNotStacked: '周额度不叠加',
    renewalRuleMonthlyNotStacked: '月额度不叠加',
    renewalRuleOverdraftPool: '透支按天数 × 日额度计算',
    renewalRuleSeparator: '；',
    continueRenewal: '继续续费',
    renewalMode: {
      title: '选择操作',
      message: '请选择“延长”或“重置”。',
      extendTitle: '延长时间',
      extendDesc: '只加有效期，不清当前用量。',
      restartTitle: '重置当前额度',
      restartDesc: '从现在重新开始，清空当前额度。',
    },
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
      ...
      models: '模型',
      untilDate: '至 {date}',
      purchaseLimit: '限购 {total} 次，剩余 {remaining} 次',
      purchaseLimitReached: '已达限购次数',
      soldOut: '不可购买',
    },
    days: '天',
    months: '个月',
    ...
    admin: {
      ...
      coupons: {
        ...
        code: '优惠券码',
        autoGenerate: '留空自动生成',
        codePlaceholder: '输入优惠券码或留空',
        status: '状态',
        type: '类型',
        fixedValue: '固定抵扣金额',
        percentValue: '减免比例（0.2 = 20%）',
        minAmount: '最低消费',
        maxDiscount: '最大减免',
        scope: '适用范围',
        maxUses: '最大使用次数',
        ...
        usageRecords: '优惠券使用记录',
        usageUsed: '已使用',
        usageRefunded: '已回退',
        deleteTitle: '删除优惠券',
        deleteConfirm: '确定要删除此优惠券吗？系统会归档该券并保留历史使用记录。',
        created: '优惠券创建成功',
        updated: '优惠券更新成功',
        deleted: '优惠券已归档',
        failedToLoad: '加载优惠券失败',
        failedToSave: '保存优惠券失败',
        failedToDelete: '删除优惠券失败',
        failedToLoadUsages: '加载优惠券使用记录失败',
        columns: {
          code: '优惠券码',
          type: '优惠',
          minAmount: '最低消费',
      ...
      dailyRevenue: '每日收入',
      revenueTrend: '收入趋势',
      revenueWithCurrency: '收入 (USD)',
      orderCountWithUnit: '订单数（单）',
      maxDailyRevenue: '最高日收入',
      maxDailyOrders: '最高日订单',
      avgDailyRevenue: '平均日收入',
      avgDailyOrders: '平均日订单',
      orderUnit: '单',
      inSelectedRange: '选中周期',
      dailyCalendar: '收入日历',
      totalOrders: '总订单',
      latestOrders: '最新订单',
      overviewPanel: '概览',
      ...
      refundMode: '退款方式',
      proportionalRefund: '按比例退款',
      proportionalRefundHint: '按当前订阅重置后的剩余天数和当天剩余额度自动计算退款金额。',
      fullRefund: '全额退款',
      fullRefundHint: '按当前最大可退金额全额退款。',
      ...
      fixedExpiresAtShort: '至 {time}',
      totalQuota: '总额度',
      totalQuotaHint: '可选。填写后用户在订阅有效期内最多可消费的 USD 总额；留空或 0 表示不限制。',
      totalQuotaInvalid: '总额度不能小于 0',
      maxBuyCount: '每人限购',
      maxBuyCountHint: '可选。每个用户最多可购买该套餐的次数；留空或 0 表示不限制。',
      maxBuyCountInvalid: '每人限购次数必须大于 0',
      sortOrder: '排序',
      forSale: '上架状态',
      onSale: '上架',
      offSale: '下架',
