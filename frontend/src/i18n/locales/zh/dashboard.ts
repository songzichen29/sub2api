export default {
  ...
  usage: {
    ...
    costDetails: '费用明细',
    appliedRateMultiplier: '本次计费倍率 ×{value}',
    currentBillingMultiplier: '本次计费倍率',
    longContextPricingApplied: '已应用长上下文阶梯计费',
    ...
    latencyDuration: '总耗时',
    outputTps: '输出速率',
    outputTpsHint: '输出 Token ÷ 生成耗时（总耗时减去首 Token 耗时）；缺少首 Token 时按总耗时计算',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
