  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        allowDailyOverdraftHint: 'When enabled, users can turn overdraft on or off on their own subscription. Off by default. Requires a daily limit.',
    ...
    channels: {
      ...
      form: {
        ...
        mappingNotePlaceholder: 'Optional note for this mapping',
        ...
        selectedCount: '{count} selected',
        importModelsFromAccounts: 'Import account models from selected groups into mapping and pricing',
        selectGroupsBeforeImport: 'Please select groups before importing models',
    ...
    riskControl: {
      ...
      moderationProtocol: 'Moderation Protocol',
      protocolOpenAI: 'OpenAI Moderation',
      protocolOpenAIDesc: 'Use OpenAI Moderation API with specialized classification model for content review.',
      protocolAnthropic: 'Anthropic LLM',
      protocolAnthropicDesc: 'Use LLM service compatible with Anthropic Messages protocol (e.g., Qwen) with system prompt to define moderation behavior.',
      systemPrompt: 'System Prompt',
      systemPromptPlaceholder: 'Enter system prompt to define LLM moderation behavior and output format...',
      systemPromptHint: 'The prompt guides the LLM on how to evaluate content and return JSON-formatted moderation results.',
      ...
      timeoutMsHint: 'LLM moderation requires longer timeout, recommend 10000-30000ms',
      ...
      downloadRequestBody: 'Download session',
    ...
    subscriptions: {
      ...
      form: {
        ...
        adjustDaysRange: 'Shift end time (Days)'
      },
      ...
      adjustRangeDaysHint: 'Positive defers, negative advances; start time stays unchanged. The "end time" preview below updates automatically.',
      ...
      resetQuotaConfirm: "Reset usage quota for '{user}'? Selected windows will be zeroed and restarted from today.",
      resetQuotaSelectorHint: 'Pick the windows to reset; the upper-bound window and unconfigured windows are not resettable.',
    ...
    accounts: {
      ...
      dataImportApplyTitle: 'Apply to all accounts (optional)',
      dataImportApplyHint: 'Checked fields override the file values for every imported account',
      dataImportTemplateTitle: 'Import Template',
      dataImportTemplateHint: 'Save frequently used import options and apply them next time with one click.',
      dataImportTemplateSelect: 'Select template',
      dataImportTemplateSave: 'Save as template',
      dataImportTemplateSaved: 'Import template saved',
      dataImportTemplateDeleted: 'Import template deleted',
      dataImportTemplateNamePrompt: 'Enter template name',
      dataImportTemplateNamePlaceholder: 'Enter template name',
      dataImportApplyTags: 'Tags',
      dataImportApplyTagsPlaceholder: 'Type tag and press Enter',
      dataImportApplyTagsHint: 'When checked, all imported accounts get these tags (file tags are replaced); empty list means explicit clear',
      dataImportApplyGroups: 'Groups',
      dataImportApplyGroupsHint: 'When checked, all imported accounts bind to these groups (overrides file bindings)',
      dataImportApplyProxy: 'Proxy',
      dataImportApplyProxyHint: 'When checked, all imported accounts use this proxy; if no proxy is selected this field is ignored',
      dataImportApplyConcurrency: 'Concurrency',
      dataImportApplyPriority: 'Priority',
      dataImportApplyModelRestriction: 'Model restriction',
      ...
      modelMappingNotePlaceholder: 'Optional note: describe the purpose, limitation, or alias of this mapping',
      allPlatforms: 'All Platforms',
      allTypes: 'All Types',
      allStatus: 'All Status',
      allGroups: 'All Groups',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          rechargeEnabled: 'Enable Recharge Rebate',
          rechargeEnabledHint: 'When enabled, invitees’ balance recharges generate rebate for the inviter.',
          subscriptionEnabled: 'Enable Subscription Rebate',
      ...
      defaults: {
        ...
        defaultUserRpmLimitHint: 'Default max requests per minute for new users; 0 = unlimited. Applied at new user creation, then automatically reset to 0 (unlimited) once the user completes any payment (balance recharge or subscription purchase/renewal).',
      ...
      site: {
        ...
        openaiFreeImageBridgeUrl: 'OpenAI Free Image Bridge URL',
        openaiFreeImageBridgeUrlHint: 'Only used to bridge OpenAI OAuth Free image requests to chatgpt2api. Other request paths are unaffected.',
        openaiFreeImageBridgeUrlPlaceholder: 'http://127.0.0.1:8000',
        openaiFreeImageBridgeAuthKey: 'OpenAI Free Image Bridge Auth Key',
        openaiFreeImageBridgeAuthKeyHintConfigured: 'A bridge auth key is already configured. Leave this empty to keep the current key.',
        openaiFreeImageBridgeAuthKeyHintMissing: 'No bridge auth key is configured yet.',
      ...
      customMenu: {
        ...
        description: 'Add custom iframe pages to the sidebar navigation. Each page can be visible to regular users or administrators. Embedded pages receive UI context only (theme, language, source URL) and do not receive the user access token.',
      ...
      payment: {
        ...
        paidUserRateEnabled: 'Auto-set paid user exclusive rate after balance recharge',
        paidUserRateTitle: 'Paid User Exclusive Rates',
        paidUserRateHint: 'Apply these group rates after a successful balance recharge.',
        paidUserRateGroup: 'Target Group',
        paidUserRateMultiplier: 'Exclusive Rate',
        paidUserRateAssignedUsers: 'Assigned Users',
        addPaidUserRateRule: 'Add Group Rate',
        noPaidUserRateRules: 'No group rate rules yet. Add a row to enable it.',
        paidUserRateBackfillSuccess: '{total} historical balance recharge users, assigned {assigned} users with {rules} rules.',
        paidUserRateBackfillFailed: '{total} historical balance recharge users, assigned {assigned} users, backfill failed: {error}',
        paidUserRateBackfillSkipped: 'Historical user backfill has not run yet.',
        selectGroup: 'Select a group',
        discountRules: 'Threshold Discounts',
        discountRulesHint: 'Orders use the highest matching threshold rule. Daily quota reset orders are excluded.',
        addDiscountRule: 'Add Discount Rule',
        noDiscountRules: 'No threshold discount rules.',
        quickAmounts: 'Quick Recharge Amounts',
        quickAmountsPlaceholder: 'e.g. 1, 10, 30, 50, 100, 200',
        quickAmountsHint: 'Separate with commas or spaces. Leave empty to use default tiers; threshold discount amounts are still added to the user page.',
        discountThreshold: 'Threshold',
        discountType: 'Type',
        discountTypeRate: 'Pay Ratio',
        discountTypeReduce: 'Fixed Discount',
        discountValue: 'Value',
        discountLabel: 'Label',
