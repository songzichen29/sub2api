...
const antigravityPresetMappings = [
  ...
  { label: '3.1-Pro→3.1-Pro-High', from: 'gemini-3.1-pro', to: 'gemini-3.1-pro-high', color: 'bg-amber-100 text-amber-700 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400' },
