...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/invoices', label: t('nav.myInvoices'), icon: OrderListIcon },
...
// Admins access user-facing status and subscription pages from this section;
// the marketplace remains a header entry so it does not duplicate admin nav.
  ...
  const baseItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/admin/orders/coupons', label: t('nav.paymentCoupons'), icon: TicketIcon },
      ],
    },
    { path: '/admin/orders/invoices', label: t('nav.invoiceManagement'), icon: OrderListIcon },
