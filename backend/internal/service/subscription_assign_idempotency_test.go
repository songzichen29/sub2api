...
func (userSubRepoNoop) UpdateDailyOverdraft(context.Context, int64, bool) error { return nil }
func (userSubRepoNoop) ActivateWindows(context.Context, int64, time.Time, time.Time, time.Time) error {
