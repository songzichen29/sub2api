...
const parameterLimitTestDriverName = "sub2api_mysql_param_limit_test"

var registerParameterLimitTestDriverOnce sync.Once

func TestAccountsToService_LargeActiveAccountSetBatchesParameterHeavyQueries(t *testing.T) {
...
func parameterLimitError(paramCount int) error {
	...
	return fmt.Errorf("driver: got %d parameters but the test driver only supports 65535 parameters", paramCount)
}
