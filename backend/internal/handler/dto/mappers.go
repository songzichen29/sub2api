...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		AllowDailyOverdraft:             g.AllowDailyOverdraft,
		AllowWeekendSkip:                g.AllowWeekendSkip,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		Extra:                   sanitizeAccountExtraForDTO(extra),
...
func userSubscriptionFromServiceBase(sub *service.UserSubscription) UserSubscription {
	out := UserSubscription{
		...
		WeekendSkipOriginalExpiresAt: sub.WeekendSkipOriginalExpiresAt,
		WeekendSkipAdminUpdatedAt:    sub.WeekendSkipAdminUpdatedAt,
		WeekendSkipAdminUpdatedBy:    sub.WeekendSkipAdminUpdatedBy,
		Source:                       sub.Source,
		ValidityDays:                 nil,
