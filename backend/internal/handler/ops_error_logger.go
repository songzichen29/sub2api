...
func setOpsRequestContext(c *gin.Context, model string, stream bool, bodies ...[]byte) {
	if c == nil {
		return
	}
	...
	if len(bodies) > 0 && len(bodies[0]) > 0 {
		c.Set(service.OpsUpstreamRequestBodyKey, bodies[0])
	}
