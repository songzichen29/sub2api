			...
			wantJSON: `
{
	...
	"data": {
		...
		"affiliate_recharge_rebate_rate": 0,
		"affiliate_subscription_enabled": false,
		"affiliate_subscription_rebate_rate": 0,
		...
		"payment_paid_user_rate_rules": null,
...
func (stubUserSubscriptionRepo) UpdateDailyOverdraft(context.Context, int64, bool) error { return nil }
