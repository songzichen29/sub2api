...
func init() {
	...
	paymentorderDescSubscriptionValidityUnit := paymentorderFields[19].Descriptor()
	...
	usersubscriptionDescAllowDailyOverdraft := usersubscriptionFields[12].Descriptor()
	...
	usersubscriptionDescSource := usersubscriptionFields[16].Descriptor()
